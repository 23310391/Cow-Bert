...
int N=30,M=20; 
int size=16;
//tamaño ventana de juego
int w = size*N; 
int h = size*M;
//dir para manejar la direccion de movimiento de la serpiente
int dir,num=4;

//structs para almacenar las coordenadas de la serpiente y fruta
struct Snake 
{ int x,y;}  s[100];
...
//primero configuramos la ventana y cargamos texturas, 
int main()
{  
	srand(time(0));
